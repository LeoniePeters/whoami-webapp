    ...
    return (
        <div>
            <div className='pattern'>
                ...
                <p className='colorpicker' style={{ backgroundColor: color1 }}
                    id="color1" onMouseEnter={showTooltip.bind(thiss, 'isTooltipActive1')}
                    onMouseLeave={hideTooltip.bind(thiss, 'isTooltipActive1')}> </p>
                <ToolTip active={isTooltipActive1} position="bottom" arrow="center" parent="#color1">
                    <div>
                        <CompactPicker
                            color={color1}
                ...
                <p className='colorpicker' style={{ backgroundColor: color2 }}
                    id="color2" onMouseEnter={showTooltip.bind(thiss, 'isTooltipActive2')}
                    onMouseLeave={hideTooltip.bind(thiss, 'isTooltipActive2')}> </p>
                <ToolTip active={isTooltipActive2} position="bottom" arrow="center" parent="#color2">
                    <div>
                        <CompactPicker
                            color={color2}
            ...
            <img onClick={handleOnClick} src={star2} alt='star2' id="star2" />
        </div>
